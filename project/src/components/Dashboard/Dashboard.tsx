...
import { Car, MapPin, Clock, AlertTriangle, Battery, Signal } from 'lucide-react';
...
const Dashboard: React.FC = () => {
  ...
  useEffect(() => {
    ...
    setStats({
      totalVehicles: vehicles.length || 1, // Show at least 1 for demo
      activeVehicles,
      totalTrips: 247, // Demo data
      totalDistance: 15420, // Demo data in km
      unreadAlerts,
    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <DashboardCard
          ...
          icon={AlertTriangle}
          color={stats.unreadAlerts > 0 ? 'red' : 'yellow'}
            ...
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="text-center p-3 bg-blue-50 rounded-lg">
                  ...
                  <div className="font-semibold text-blue-600">{currentVehicle.batteryLevel}%</div>
                </div>
                <div className="text-center p-3 bg-green-50 rounded-lg">
                  <Signal className="w-5 h-5 text-green-600 mx-auto mb-1" />
                  <div className="text-sm text-gray-600">GPS Signal</div>
                  <div className="font-semibold text-green-600">{currentVehicle.gpsSignal}%</div>
                </div>
              </div>
              ...
              <div className="p-4 bg-yellow-50 rounded-xl">
                <div className="flex items-center space-x-2 mb-2">
                  ...
                  <span className="font-medium text-yellow-800">Current Location</span>
                </div>
                <p className="text-sm text-yellow-700">
                  {currentVehicle.location.latitude.toFixed(6)}, {currentVehicle.location.longitude.toFixed(6)}
                </p>
          ...
          <div className="space-y-3">
            ...
            {alerts.length === 0 && (
              <div className="text-center py-8 text-gray-500">
                ...
                <p className="text-sm">Your vehicles are secure</p>
              </div>
            )}
          </div>
        </div>
